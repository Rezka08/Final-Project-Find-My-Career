...
class ProfileController extends Controller
{
    ...
    public function showProfile()
    {
        ...
        // Jika profile belum ada, bisa redirect ke halaman create profile
        if (!$profile) {
            return redirect()->route('profile.create')->with('info', 'Please Complete Your Profile');
        }
        
        // Ambil skill jika profile ditemukan
        $skill = Skill::where('id_profile', $profile->id)->get();
        
        return view('profile.show', compact('profile', 'skill', 'user'));
    }
}
