            ...
            <div class="row gy-5 gx-4">
                ...
                <div class="col-lg-4">
                    <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                        <h4 class="mb-4">Profile Job Seeker</h4>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>Name: {{ $profile->nama }} </p>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>email: {{ $profile->email }} Position</p>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>Phone Number: {{ $profile->no_hp }}</p>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>Age: {{ $profile->umur }}</p>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>Gender: {{ $profile->jenis_kelamin }}</p>
                        <p><i class="fa fa-angle-right text-primary me-2"></i>Description: {{ $profile->deskripsi }}</p>
                        <h4 class="mb-2">CV / Sertifikat</h4>
                                ...
                                <div class="form-group row mt-5">
                                    <div class="col">
                                        <select id="status" name="status" class="form-control select2"
                                            ...
                                            <option value="dibatalkan">Declined</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col">
