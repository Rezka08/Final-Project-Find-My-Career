...
Route::group(['middleware' => ['auth', 'RoleMiddleware:Admin']], function () {
    ...
    Route::get('/admin/apply/{id}', 'ApplyController@show');
    Route::put('/admin/apply/{id}/accept', 'ApplyController@accept');
    Route::put('/admin/apply/{id}/reject', 'ApplyController@reject');
    Route::get('/apply/create/{id}', [ApplyController::class, 'create'])->name('apply.create');
