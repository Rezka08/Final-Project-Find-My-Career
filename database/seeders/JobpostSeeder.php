    ...
    public function run(): void
    {
        ...
        $jobs = [
            [
                ...
                'deskripsi' => 'Kami mencari profesional pemasaran yang berkomitmen untuk bergabung dengan tim kami di Apple. Anda akan memiliki kesempatan untuk mengembangkan strategi pemasaran dan berkolaborasi dengan tim lintas fungsi. Bergabunglah dengan kami untuk menciptakan dampak positif dan pertumbuhan bersama!',
                'gaji' => 5000000,
                'id_company' => 1,
                'id_user' => 2,
                'created_at' => now(),
            ...
            [
                ...
                'type' => 'full-time',
                'email' => 'google@gmail.com',
                'deskripsi' => 'Kami mencari profesional dalam bidang penjualan dan komunikasi untuk bergabung dengan tim kami di Google. Anda akan bertanggung jawab dalam mengembangkan strategi penjualan, berkomunikasi efektif dengan pelanggan, dan mencapai target penjualan. Bergabunglah dengan kami untuk menjadi bagian dari pertumbuhan kami!',
                'gaji' => 4500000,
                'id_company' => 2,
                'id_user' => 3,
                'created_at' => now(),
            ...
            [
                ...
                'type' => 'full-time',
                'email' => 'google@gmail.com',
                'deskripsi' => 'Kami mencari individu kreatif dan berbakat untuk bergabung dengan tim kami di Google dalam posisi Design & Creative. Sebagai bagian dari tim ini, Anda akan memiliki tanggung jawab dalam menghasilkan desain visual yang menarik dan konsep kreatif. Kami mencari seseorang yang bersemangat untuk berinovasi dan membantu menciptakan pengalaman visual yang luar biasa bagi pelanggan kami. Bergabunglah dengan kami dan berkontribusi pada keberhasilan Google melalui kreativitas Anda!',
                'gaji' => 2000000,
                'id_company' => 2,
                'id_user' => 3,
                'created_at' => now(),
